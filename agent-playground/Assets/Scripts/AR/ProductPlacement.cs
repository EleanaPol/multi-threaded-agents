...
public class ProductPlacement : MonoBehaviour
{
    ...
    [SerializeField] GameObject Object = null;
    ...
    void Start()
    {
        ...
        mOriginalChairScale = Object.transform.localScale;
        Reset();
    }
    ...
    void SnapProductToMousePosition()
    {
        if (TouchHandler.sIsSingleFingerDragging || VuforiaRuntimeUtilities.IsPlayMode() && Input.GetMouseButton(0))
        {
            if (!UnityRuntimeCompiledFacade.Instance.IsUnityUICurrentlySelected())
            {
                ...
                {
                    Object.transform.position = cameraToPlaneHit.point;
                    mIsPlaced = false;
                }
    ...
    public void Reset()
    {
        ...
        Object.transform.localScale = Vector3.Scale(mOriginalChairScale, ProductScale);
    ...
    public void OnAutomaticHitTest(HitTestResult result)
    {
        ...
        if (!mIsPlaced)
        {
            ...
            Object.transform.position = result.Position;
        }
    }
    ...
    void SetupFloor()
    {
        ...
        else
        {
            ...
            floor.transform.SetParent(Object.transform.parent);
